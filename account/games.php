...
<div class="container" style="margin-top: 210px;">
    ...
    <?php require "post_games.php";//ESTRUTURA DO POST NUM FICHEIRO Á PARTE ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data" action="commands/inserirPost.php">
                    ...
                    <input type="hidden" value="3" name="id_cat"><!-- Mandar em variavel escondida o tipo da categoria do post -->
